...
const ASSETS_TO_CACHE = [
    ...
    './css/components.css',
    './css/pages.css',
    './js/utils/router.js?v=26',
    './js/utils/storage.js?v=26',
    './js/engine/symptoms.js?v=26',
    './js/engine/triage.js?v=26',
    './js/engine/speech.js?v=26',
    './js/pages/splash.js?v=26',
    './js/pages/dashboard.js?v=26',
    './js/pages/voice.js?v=26',
    './js/pages/results.js?v=26',
    './js/pages/firstaid.js?v=26',
    './js/pages/emergency.js?v=26',
    './js/pages/network.js?v=26',
    './js/pages/hospitals.js?v=26',
    './js/pages/settings.js?v=26',
    './js/pages/medicalid.js?v=26',
    './js/pages/vault.js?v=26',
    './js/pages/map.js?v=26',
    './js/pages/triage-chat.js?v=26',
    './js/app.js?v=26',
    './data/symptoms.json',
    './data/rules.json',
    './data/firstaid.json',
