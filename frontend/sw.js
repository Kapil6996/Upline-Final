...
const ASSETS_TO_CACHE = [
    ...
    './css/components.css',
    './css/pages.css',
    './js/utils/router.js?v=25',
    './js/utils/storage.js?v=25',
    './js/engine/symptoms.js?v=25',
    './js/engine/triage.js?v=25',
    './js/engine/speech.js?v=25',
    './js/pages/splash.js?v=25',
    './js/pages/dashboard.js?v=25',
    './js/pages/voice.js?v=25',
    './js/pages/results.js?v=25',
    './js/pages/firstaid.js?v=25',
    './js/pages/emergency.js?v=25',
    './js/pages/network.js?v=25',
    './js/pages/hospitals.js?v=25',
    './js/pages/settings.js?v=25',
    './js/pages/medicalid.js?v=25',
    './js/pages/vault.js?v=25',
    './js/pages/map.js?v=25',
    './js/pages/triage-chat.js?v=25',
    './js/app.js?v=25',
    './data/symptoms.json',
    './data/rules.json',
    './data/firstaid.json',
